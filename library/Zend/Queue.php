...
class Zend_Queue implements Countable
{
    ...
    public function setAdapter($adapter)
    {
        ...
        if (!$adapter instanceof Zend_Queue_Adapter_AdapterInterface) {
            require_once 'Zend/Queue/Exception.php';
            throw new Zend_Queue_Exception("Adapter class '" . ($adapterName !== null ? get_class($adapterName) : get_class()) . "' does not implement Zend_Queue_Adapter_AdapterInterface");
        }
    ...
    public function getQueues()
    {
        if (!$this->isSupported('getQueues')) {
            throw new Zend_Queue_Exception( __FUNCTION__ . '() is not supported by ' . ($this->getAdapter() !== null ? get_class($this->getAdapter()) : get_class()));
        }
    ...
    public function debugInfo()
    {
        ...
        $info['adapter']                  = $this->getAdapter() !== null ? get_class($this->getAdapter()) : get_class();
